...
public class writePoints : MonoBehaviour
{
    ...
    public void AddNewScore()
    {
        ...
        newName = Name.PlayerName; // set newName to players name

        NewScore = PointsLives.highScorePref; // set NewScore to high score
        newScore = NewScore.ToString(); // change it to string
